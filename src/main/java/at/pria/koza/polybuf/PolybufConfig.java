 ...
 * {@link PolybufSerializable}). Note that this class does not have a notion of what message type a{@code PolybufIO}
 * corresponds to, and thus does not enforce anything of the sort. Implementors are free to design {@code PolybufIO}
 * classes that work for any number and any type of messages. The user simply has to register that {@code PolybufIO}
